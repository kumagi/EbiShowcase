...
2. **Visual Effects Lab** — thirteen focused drawing toys / magic showcases between core and genre tracks. Early steps isolate the rendering pipeline; later steps push composed fire/ice/thunder/light/dark demos. Their pages are generated from `scripts/gen-visual-effects.mjs`.
