...
2. **Visual Effects Lab** — Basic (drawing grammar + magic showcases) plus Advanced (LEVEL 01–12 remakes with a separate FX layer). Pages come from `scripts/gen-visual-effects.mjs`. Counted outside the 105 gate.
