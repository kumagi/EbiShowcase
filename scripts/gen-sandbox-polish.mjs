...
const lessons = [
  {
    slug: "block-feedback",
    ja: {s:['振りかぶり', '接触tick', 'HP減算', '破片と揺れ', '元姿勢'],
      title: "ブロックが壊れる一瞬を作る",
    ...
    en: {s:['anticipation', 'contact tick', 'subtract HP', 'chips and shake', 'recover pose'],
  ...
  },
  {
    ...
    ja: {s:['島データ読込', '資源を採掘', '夜の敵', '目標判定', '次の島へ'],
    ...
    en: {s:['load island', 'mine resources', 'night foes', 'goal check', 'sail onward'],
...
const finalLesson = {
  slug: "ebi-craft",
  ja: {s:['島1:昼の採掘', 'ランタン準備', '島2:夜の敵', '島3:総合', '得点と再挑戦'],
  ...
  en: {s:['island 1 daylight mining', 'ready lanterns', 'island 2 night foes', 'island 3 combined', 'score and retry'],
    title: "Ebi Craft Expedition",
