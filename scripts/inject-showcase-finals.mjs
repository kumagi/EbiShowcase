...
const ja = {
  ...
  "ebi-fighters": ["ネオン港のリング", "間合いを読むAI", "ヒットストップ"],
  "ebi-merge": ["ガラス容器の物理", "連鎖マージ", "上端まで続くスコア挑戦"],
...
const en = {
  ...
  "ebi-fighters": ["a neon harbor ring", "spacing-aware AI", "hit-stop impact"],
  "ebi-merge": ["glass-container physics", "combo merges", "a score run to the top line"],
