...
g.fx.Ring(x, y, 1.2, tint)`,
  },
  {
    ...
    ja: {
      ...
      lab: {
        eyebrow: "TRY IT / 判定→演出",
        title: "止めた位置が、演出の強さへ変わる",
        p: "マーカーを動かして「判定！」。play が中心からの距離を Perfect / OK / Miss に変え、その判定値だけを fx へ渡します。位置が同じなら、点数と花火も必ず同じです。",
      },
      play: {
        title: "ゾーンで止めよう",
    ...
    en: {
      ...
      lab: {
        eyebrow: "TRY IT / GRADE → FX",
        title: "Turn a stopped position into FX strength",
        p: "Move the marker and press Judge. play turns distance from center into Perfect / OK / Miss, then passes only that grade to fx. The same position always produces the same score and burst.",
      },
      play: {
