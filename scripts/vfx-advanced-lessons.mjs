...
export const advancedLessons = [
  {
    ...
    ja: {
      ...
      lab: {
        eyebrow: "TRY IT / SPLIT",
        title: "箱はふたつ",
        p: "左がゲームの数字、右が演出の粒。混ぜないイメージを掴もう。",
      },
      play: {
        title: "タッチして花火を見よう",
    ...
    en: {
      ...
      lab: {
        eyebrow: "TRY IT / SPLIT",
        title: "Two boxes",
        p: "Play numbers on one side, effect particles on the other—don’t mix them.",
      },
      play: {
...
// NEVER: objects []any{star, spark, ...}`,
  },
  {
    ...
    ja: {
      ...
      lab: {
        eyebrow: "TRY IT / SPLIT",
        title: "物理スイッチ／演出スイッチ",
        p: "頭の中で、片方だけOFFにできるか想像してみよう。",
      },
      play: {
        title: "飛んでパイプをくぐろう",
        p: "タップで羽ばたき。物理は play、キラキラは fx。LIVE GO を見て構造を確認。",
      },
    ...
    en: {
      ...
      lab: {
        eyebrow: "TRY IT / SPLIT",
        title: "Physics switch / FX switch",
        p: "Imagine turning only one off—the other should still make sense.",
      },
      play: {
        title: "Fly through pipes",
        p: "Tap to flap. Physics is play; sparkles are fx. Read the LIVE GO struct.",
      },
  ...
  },
  {
    ...
    ja: {
      ...
      lab: { eyebrow: "TRY IT / SPLIT", title: "ボールはボール", p: "見た目の尾を ball に埋め込まない。" },
      play: {
        title: "反射を派手に",
    ...
    en: {
      ...
      lab: { eyebrow: "TRY IT / SPLIT", title: "Ball stays ball", p: "Don’t embed the visual tail inside ball." },
      play: {
...
if frame%3 == 0 {
  ...
  },
  {
    ...
    ja: {
      ...
      lab: { eyebrow: "TRY IT / SPLIT", title: "当たり判定は残すな", p: "見た目の破片をクリックできない／当たらない。" },
      play: {
        title: "ブロックを砕こう",
    ...
    en: {
      ...
      lab: { eyebrow: "TRY IT / SPLIT", title: "No hitbox on debris", p: "Pretty shards shouldn’t be clickable/collidable." },
      play: {
        title: "Smash bricks",
