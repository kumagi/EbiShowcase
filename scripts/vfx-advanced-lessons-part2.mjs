...
g.fx.Burst(food.x, food.y, 24, 3, tint, true)`,
  ...
  },
  {
    ...
    ja: {
      ...
      codeHead: { eyebrow: "IN THE DEMO", h: "前フレームと比較", p: "状態の差分がイベントになる。" },
      whys: [
        { eyebrow: "WHY EDGE?", h: "連打防止", p: "接地中は毎フレームイベントにしない。" },
    ...
    en: {
      ...
      deepEyebrow: "DEEP DIVE / EDGE TRIGGER",
      deepH: "Not every frame—<br>the moment it changes",
...
if landed { g.fx.Burst(g.x, g.y+h, 20, 2.5, dust, true) }`,
  },
  {
    ...
    ja: {
      ...
      lab: { eyebrow: "TRY IT / SPLIT", title: "HP が真実", p: "点滅だけで倒した判定にしない。" },
    ...
    en: {
      ...
      lab: { eyebrow: "TRY IT / SPLIT", title: "HP is truth", p: "Don't defeat foes because they blinked." },
  ...
  },
  {
    ...
    ja: {
      navConcept: "総仕上げ",
      title: "ボンブで弾を消し、爆発は演出へ",
      lead: "応用編のゴール。ボンブは近くの bullets を削除（play）し、同時に巨大な Ring と Flash（fx）。弾を演出用に再利用しない——消してから花火。",
      ...
      concepts: [
        ...
        { h: "ボンブ", p: "弾を削除するルール。", code: "filter bullets" },
        { h: "花火", p: "安全。見た目だけ。", code: "fx.Ring+Burst" },
      ],
      lab: { eyebrow: "TRY IT / SPLIT", title: "危険／安全", p: "左＝弾（危険）、右＝粒（安全）。" },
      play: {
        title: "避けてボンブせよ",
        p: "弾幕を避け、ボンブで一掃。削除は play、爆発は fx。LIVE GO で bullets と fx.parts を見比べよう。",
      },
