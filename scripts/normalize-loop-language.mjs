...
const replacements = [
  ...
  ["LEVEL 01 の Update / Draw</a> と同じ枠の中に書きます。", "LEVEL 01</a>の状態境界に沿って書きます。ルールはUpdate、描画は自由です。"],
  ["LEVEL 01 の Update / Draw</a> と同じ枠です。", "LEVEL 01</a>の状態境界です。"],
  ["LEVEL 01の状態境界に沿って書きます。ルールはUpdate、描画は自由です。</p>", "LEVEL 01</a>と同じく、位置や得点などゲームの中身はUpdateで進めます。Drawは中身を変えず、画面への見せ方だけを担当します。</p>"],
  ["LEVEL 01</a>の状態境界に沿って書きます。ルールはUpdate、描画は自由です。</p>", "LEVEL 01</a>と同じく、位置や得点などゲームの中身はUpdateで進めます。Drawは中身を変えず、画面への見せ方だけを担当します。</p>"],
