...
const notes = {
  ...
  "village-walk":"タイル衝突は移動先の地図番号が壁か調べること、向きは天次郎が上下左右のどちらを見ているか。map[y][x]を読み、通路なら座標と向きを更新します。|if map[ny][nx]!=Wall { x,y,dir=nx,ny,inputDir }",
  ...
  "vfx-magic-light":"放射フレアは中心から外へ伸びる光線、ブルームは強い光の周りに見える柔らかなぼかし。16本は円を22.5度ずつ分けた見栄えの例で、glow画像を薄く重ねてブルームを作ります。|angle := 2 * math.Pi * float64(i) / 16",
