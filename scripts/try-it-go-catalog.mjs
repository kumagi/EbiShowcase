...
export const catalog = {
  ...
  geom: {
    lines: [
      { id: "pivot", code: "op.GeoM.Translate(-w/2, -h/2) // image center → origin" },
  ...
  gravity: {
    lines: [
      { id: "v", code: "vy += g" },
      { id: "y", code: "y += vy" },
      { id: "floor", code: "if y > floor { y = floor; vy = -vy * 0.45 }" },
    ],
    buttons: {
  ...
  friction: {
    lines: [
      { id: "move", code: "pos.x += vx; pos.y += vy" },
      { id: "damp", code: "vx *= friction; vy *= friction" },
      { id: "snap", code: "if hypot(vx, vy) < stop { vx, vy = 0, 0 }" },
    ],
    buttons: {
      "data-lab-step": { ids: ["move", "damp", "snap"] },
      "data-lab-reset": { clear: true },
    },
  },
  "deck-cycle": {
    ...
    buttons: {
      "data-lab-spend": { ids: ["play"] },
      "data-lab-end": { ids: ["empty", "shuffle", "draw"] },
      "data-lab-reset": { clear: true },
    },
  },
  "merge-same": {
...
export const lineCaptions = {
  ...
  en: {
    ...
    pivot: "Image half → origin",
    rot: "Rotate",
    scale: "Scale",
    v: "Add gravity",
    y: "Advance position",
    floor: "Bounce and damp on floor",
    damp: "Multiply by friction",
    snap: "Snap tiny speed to zero",
    play: "Hand → discard",
    empty: "If draw empty, take discard",
