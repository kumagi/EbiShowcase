...
function page(lang) {
  ...
  const t = ja
    ? {
        ...
        h1: "まっさらなパソコンから、<br><em>空の窓</em>を開くまで。",
        ...
        step1: {
          ...
          n: "01",
          h: "Go をインストールする",
          p: "Ebitengine は Go で書かれたゲームエンジンです。先に Go 本体が必要です。いまの公式要件は Go 1.22 以降（このリポジトリは 1.24 向け）。",
          winTitle: "Windows",
          winBody: [
        ...
        step3: {
          ...
          cmd: "go version",
          ok: "例: go version go1.24.4 windows/amd64 のように、go1.22 以上の数字が出れば成功です。",
    ...
    : {
        ...
        crumb: "SPECIAL GUIDE",
        eyebrow: "START HERE / ENVIRONMENT",
        h1: "From a blank computer<br>to an <em>empty window</em>.",
        ...
        step1: {
          ...
          n: "01",
          h: "Install Go",
          p: "Ebitengine is a Go game engine, so install Go first. Official requirement: Go 1.22+. This repository targets 1.24.",
          winTitle: "Windows",
          winBody: [
        ...
        step3: {
          ...
          cmd: "go version",
          ok: "Success looks like go version go1.24.4 windows/amd64 — any go1.22+ is fine.",
