...
func (g *game) Draw(s *ebiten.Image) {
	...
	topY := sy + 28
	botY := sy + sh - 28
	vector.DrawFilledRect(s, float32(g.cx-padHW), float32(topY), float32(padHW*2), 12, color.RGBA{255, 120, 90, 255}, false)
	vector.DrawFilledRect(s, float32(g.px-padHW), float32(botY), float32(padHW*2), 12, color.RGBA{45, 226, 194, 255}, false)
